...
$_LANG['cfg_name']['a_card_top'] = '普卡业绩奖（对碰奖）（%）';
...
$_LANG['cfg_name']['b_card_top'] = '银卡业绩奖（对碰奖）（%）';
...
$_LANG['cfg_name']['c_card_top'] = '金卡业绩奖（对碰奖）（%）';
...
$_LANG['cfg_name']['d_card_top'] = '钻卡业绩奖（对碰奖）（%）';
