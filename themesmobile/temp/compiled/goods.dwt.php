...
<section class="index_floor is_scroll">
    <h2>
      ...
      <div class="bd">
        <ul>
           <?php $_from = $this->_var['fittings']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods_0_27889400_1521251530');if (count($_from)):
    foreach ($_from AS $this->_var['goods_0_27889400_1521251530']):
?>
          <li>
            <a href="<?php echo $this->_var['goods_0_27889400_1521251530']['url']; ?>">
              <div class="products_kuang">
                <img src="<?php echo $this->_var['goods_0_27889400_1521251530']['goods_thumb']; ?>"></div>
              <div class="goods_name"><?php echo htmlspecialchars($this->_var['goods_0_27889400_1521251530']['short_name']); ?></div>
              <div class="price" >
              <p href="<?php echo $this->_var['goods_0_27889400_1521251530']['url']; ?>"><?php echo $this->_var['goods_0_27889400_1521251530']['fittings_price']; ?> </p>
                 <a href="javascript:addToCart(<?php echo $this->_var['goods_0_27889400_1521251530']['goods_id']; ?>);" class="car">
                    <img src="themesmobile/68ecshopcom_mobile/images/xin/cutp.png">
                </a>
              </div>
            </a>
