<?php exit;?>a:3:{s:8:"template";a:4:{i:0;s:60:"D:/phpStudy/WWW/xu/themesmobile/68ecshopcom_mobile/goods.dwt";i:1;s:70:"D:/phpStudy/WWW/xu/themesmobile/68ecshopcom_mobile/library/up_menu.lbi";i:2;s:76:"D:/phpStudy/WWW/xu/themesmobile/68ecshopcom_mobile/library/goods_gallery.lbi";i:3;s:71:"D:/phpStudy/WWW/xu/themesmobile/68ecshopcom_mobile/library/comments.lbi";}s:7:"expires";i:1521255130;s:8:"maketime";i:1521251530;}<!DOCTYPE html >
<html>
<head>
...
<title>可爱卡通餐盘水果盘点心盘 盘子儿童托盘餐具6件套_厨具_家纺家居_鸿宇科技多用户商城</title>
...
<div class="goods_nav hid" id="menu">
     ...
     <form action="share_goods.php" method="post" id="share_form">
            <input type="hidden" name="content" value="可爱卡通餐盘水果盘点心盘 盘子儿童托盘餐具6件套">
            <input type="hidden" name="pics" value="images/201507/goods_img/231_G_1437587773725.jpg">
            <input type="hidden" name="gid" value="231">
            <input type="hidden" name="url" value="http://www.xu.com/goods.php?id=231">
     </form>
  ...
  <div id="slider" class="slider" style="overflow: hidden; visibility: visible; list-style: none; position: relative;">
    <ul id="sliderlist" class="sliderlist" style="position: relative; overflow: hidden; transition: left 600ms ease; -webkit-transition: left 600ms ease; width: 2400px; left: -600px;">
             <li style="float: left; display: block; width: 600px;"><span><a  href="javacript:void(0)"><img title="" width="100%" src="images/201507/goods_img/231_P_1437587773973.jpg"></a></span></li>
           </ul>
    <div id="pagenavi">
          ...
          <form action="javascript:addToCart(231)" method="post" id="purchase_form" name="ECS_FORMBUY" >
            <div class="product_info">
              <div class="info_dottm">
                <h3 class="name">可爱卡通餐盘水果盘点心盘 盘子儿童托盘餐具6件套</h3>
              ...
              <dt> <span id="ECS_GOODS_AMOUNT">99.00</span><font>价格：118.80</font>                                  <p>购买此商品赠送99积分</p>
                                  </dt>
                            </dl>
              <ul class="price_dottm">
               <li style=" text-align:left">折扣：折</li>
               <li>0人评价</li>
               <li style=" text-align:right">人已付款</li> 
              </ul>
              </div>             
 <section id="search_ka" class="huodong">
   ...
   <ul class="youhui_list1">
               ...
               <ul class="youhui_list1" style="margin-top:0px;"> 
                          <li><img src="themesmobile/68ecshopcom_mobile/images/hui.png">购买此商品赠送： 99</li> 
	...
	<li style=" border-bottom:1px solid #eeeeee">
        <div class="item1">
         ...
         <span class="ui-number">
          ...
          <input type="text" class="num" id="number" onblur="changePrice();" name="number" value="1" min="1" max="3332"/>
...
<div class="subNavBox" > 
    ...
    <li  class="user_price">			
         ...
         <b class="p-price-v">94.05</b>
         </p>
             <p>
         <span class="key">金牌会员：</span>
         <b class="p-price-v">89.10</b>
         </p>
             <p>
         <span class="key">钻石会员：</span>
         <b class="p-price-v">84.15</b>
         </p>
...
<div class="ui-sx bian1"> 
<div class="subNavBox" > 
<div class="subNav" style=" border:0;"><a href="pocking.php?id=231" style=" border:0px;"><strong>自提点</strong></a></div>
</div>
</div> 
    ...
    <h2 style=" border-bottom:1px solid #ddd ">
      ...
      <ul class="xiangq">
                       <li><p>商品货号：</p><span>ECS000231 </span><li>
...
554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";i:231;}554fcae493e564ee0dc75bdf2ebf94ca</div> 
...
<div class="footer_nav">
 ...
 <li><a href="javascript:collect(231)" id="favorite_add"><em class="goods_nav3"></em><span>收藏</span></a></li>
 </ul>
 <dl>
 <dd class="flow"><a class="button active_button" href="javascript:addToCart(231);">加入购物车</a> </dd>
 <dd class="goumai"><a style="display:block;" href="javascript:addToCart1(231)">立即购买</a> </dd>
 </dl>                
</div>                
<script type="text/javascript">
var goods_id = 231;
