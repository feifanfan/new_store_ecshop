...
<title>雅鹿全棉四件套纯棉套件床上用品 回忆蓝 1.8米床_家纺_家纺家居_鸿宇科技多用户商城</title>
...
<body>
<input type="hidden" id="chat_goods_id" value="140" />
...
<table cellpadding=0 cellspacing=0 width="90%" border=0>  
    <tr> 
      ...
      <p style="font-size:15px;font-weight:bold;color:#F52648;padding-bottom:5px;">雅鹿全棉四件套纯棉套件床上用品 回忆蓝 1.8米床</p>
    ...
    <tr> 
      ...
      <input type="hidden" value="140" name="goods_id" id="goods_id">
  ...
  <div class="tell_me_con">
  	<table cellpadding="0" cellspacing="0" width="100%" border="0">
        ...
        <td colspan="2" align="left" style="padding:15px 0 15px 0;"><div style="background:#FFFDEE ;padding:10px 10px;border:1px dotted #ff3300;height:40px;line-height:150%; font-weight:normal">
            <p style="font-size:15px;color:#F52648;padding-bottom:5px;">雅鹿全棉四件套纯棉套件床上用品 回忆蓝 ...</p>
    ...
    <table cellpadding=0 cellspacing=0 width="100%" border=0>
      ...
      <tr>
        <td class="td_l">&nbsp;</td>
        <td align="left" class="td_r"><input type="button" value="提交" onclick="tell_me1(140)" class="tell_btn"/>
...
$('.search-type li').click(function() {
  ...
  <div class="blank"></div>
  <div class="w">
  <div class="breadcrumb"><i></i><a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=6">家纺家居</a> <code>&gt;</code> <a href="category.php?id=306">家纺</a> <code>&gt;</code> 雅鹿全棉四件套纯棉套件床上用品 回忆蓝 1.8米床</div>
</div>
<div class="blank"></div>
  <div class="w">
      ...
      <form action="javascript:addToCart(140)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
        <div class="clearfix" style="width:591px; min-height:510px;">
          <div class="goods_info">
            <div id="name">
              <h1>雅鹿全棉四件套纯棉套件床上用品 回忆蓝 1.8米床</h1>
            </div>
              ...
              <div class="mar_l">
                <p> 
                  ...
                  <span class="depreciate"><a href="javascript:showDiv(140);" style="color:#ffffff;text-decoration:none;">降价通知</a></span> </p>
              </div>
              <div class="show_price" style="z-index:101"> 
                                <div class="market_prices_t"> <span class="price">市场价</span><font class="market_price">399.59</font> </div>
                  ...
                  <div class="hover" style="display:none;" id="vip2" onmouseover="hidevip1()" onmouseout="showvip1()"> <span class="rmbPrice">会员等级价格<i></i></span> 
                    ...
                    <span class="rmbPrice"> 普通会员：333.00</span> 
                     
                    </br>
                    <span class="rmbPrice"> 铜牌会员：316.35</span> 
                     
                    </br>
                    <span class="rmbPrice"> 金牌会员：299.70</span> 
                     
                    </br>
                    <span class="rmbPrice"> 钻石会员：283.05</span> 
...
document.getElementById('vip2').style.display="none";
            ...
            <div id="summary-qita" class="clearfix">
              <ul class="qita">
                <li>
                  <p>累积评价<span><a href="/goods.php?id=140#os_pinglun">0人评价</a></span></p>
                </li>
                <li>
                  <p>累计销量<span>0</span></p>
                </li>
                                <li style="border:none">
                  <p>赠送积分<span><font id="ECS_GOODS_AMOUNT_jf">333</font></span></p>
                                </ul>
            </div>
            <ul id="summary">
              <script type="text/javascript">
...
var myString=new Array();
                ...
                <div class="dd">
                  <div class="wrap-input"> 
                    ...
                    <a class="btn-add" href="javascript:;" onclick="goods_add();changePrice();">增加数量</a> 
                                                                             （库存<font id="shows_number">43451 </font>）
                                      </div>
                </div>
              </li>
                          </ul>
            <div class="buyNub-buy-wrap">
             ...
             <div id="choose-btns1" class="buyNub-buy" style="display:none"> 
                ...
                <a onclick="tell_me(140)" class="tell_me"/><i></i>到货通知</a>
                
                <a href="javascript:collect(140)" class="btn-coll ">收藏</a>   
              </div>
     
              <div id="choose-btns" class="buyNub-buy"> 
                 
                <a href="javascript:addToCart(140,0,1)" name="bi_addToCart" class="u-buy1">立即购买</a> <a href="javascript:addToCart(140)" name="bi_addToCart" class="u-buy2">加入购物车</a> 
                 
                <a href="javascript:collect(140)" class="btn-coll ">收藏</a> <a id="phone" class="btn-phone" style="position:relative;cursor:pointer">去手机购买
                <div id="phone_tan" style="display:none"> <span class="arr"></span>
                  <div class="m-qrcode-wrap"> <img src="erweima_png.php?id=140" width="100" height="100" /> </div>
                </div>
                </a>  
              </div>
              <script type="text/javascript">
      ...
      <div id="preview">
        <div  class="goods_img" id="li_140"> <a href="images/201507/source_img/140_P_1437528915923.jpg" class="MagicZoom" id="zoom" rel="zoom-position: right;">
                    <img  src="images/201507/goods_img/140_P_1437528915688.jpg" class="goodsimg pic_img_140" id="goods_bimg" width="378" height="378" style="border:#DDDDDD 1px solid; width:378px; height:378px;" />
                    </a> </div>
...
<div class="clearfix" class="goods_picture"> <span class="scrleft" onmouseover="moveLeft()" onmousedown="clickLeft()" onmouseup="moveLeft()" onmouseout="scrollStop()"></span>
  <div class="gallery">
    <div id="demo">
      <div id="demo1" style="float:left;">
        <ul id="goods_gallery">
                    <li>
	    <a  href="images/201507/source_img/140_P_1437528915923.jpg" rel="zoom-id: zoom;" rev="images/201507/goods_img/140_P_1437528915688.jpg"   title="" >
	    <img src="images/201507/thumb_img/140_thumb_P_1437528915106.jpg" alt="雅鹿全棉四件套纯棉套件床上用品 回忆蓝 1.8米床" class="B_blue"  />
	    </a>
          </li>
                  </ul>
      </div>
  ...
  <script>
      ...
      function clickRight() {
        ...
        <div id="short-share">
          <div id="view-bigimg" class="fl" style="margin-right:20px;"><b></b><a href="javascript:;" onclick="window.open('gallery.php?id=140'); return false;" target="_blank">查看大图</a></div>
		...
		document.getElementById("bdshell_js").src = "http://bdimg.share.baidu.com/static/js/shell_v2.js?cdnversion=" + Math.ceil(new Date()/3600000);
          ...
          <div class="fl com-pare"> <a class="compare-btn" data-goods="140" data-type="0" onclick="Compare.add(140,'雅鹿全棉四件套纯棉套件床上用品 回忆蓝 1.8米床','0', 'images/201507/thumb_img/140_thumb_G_1437528915082.jpg', '333.00 ')"></a> </div>
          <div class="clb"></div>
        </div>
      </div>
      <div id="supp_info"> 
...
<input type="hidden" id="chat_supp_id" value="7" />
  ...
  <ul class="score_detail">
    ...
    <dl id="hotline">
    <dt >客 服 QQ&nbsp;&nbsp;&nbsp;&nbsp;<em><a href="http://wpa.qq.com/msgrd?v=3&uin=1527200768&site=qq&menu=yes" target="_blank" alt="点击这里联系我" title="点击这里联系我"><img src="http://wpa.qq.com/pa?p=1:1527200768:4" height="16" border="0" alt="QQ" /></a></em></dt>
    <dd > </dd>
    <div class="ghs_clear"></div>
  </dl>
      <dl id="hotline">
    <dt >客服旺旺&nbsp;&nbsp;&nbsp;&nbsp;<em><a href="http://amos1.taobao.com/msg.ww?v=2&uid=huan1314921&s=2" target="_blank"><img src="http://amos1.taobao.com/online.ww?v=2&uid=huan1314921&s=2" width="16" height="16" border="0" alt="淘宝旺旺" /></a></em></dt>
    <dd > </dd>
    <div class="ghs_clear"></div>
  </dl>
   <!--   <dl id="hotline">
...
$(function(){
    ...
    <div class="right goods_right">       <div id="wrapper" class="m m1">
        <div class="mt" id="main-nav-holder">
          <ul class="tab" id="nav">
            <li class="boldtit_list h_list" onclick="change_widget(1, this);"><a href="/goods.php?id=140#os_canshu">规格参数</a></li>
            <li class="boldtit_list" onclick="change_widget(1, this);"><a href="/goods.php?id=140#os_jieshao" >商品介绍</a></li>
            <li class="boldtit_list" onclick="change_widget(1, this);"><a href="/goods.php?id=140#os_pinglun" >商品评价(0)</a></li>
            <li class="boldtit_list" onclick="change_widget(1, this);"><a href="/goods.php?id=140#os_shouhou" >售后保障</a></li>
          </ul>
          <div style="width:170px;float:right; position:relative;left:0;top:0"> <a href="javascript:addToCart(140)" name="bi_addToCart"  class="right_add" >加入购物车</a>
            <div class="ce_right">
              <ul class="abs_ul">
        ...
        <div id="main_widget_1">
          <div class="mc" id="os_canshu">
            <ul class="detail-list">
              <li>商品名称：雅鹿全棉四件套纯棉套件床上用品 回忆蓝 1.8米床</li>
              <li>商品编号：ECS000140</li>
              <li>品牌：<a href="brand.php?id=78" >罗莱</a></li>
...
<div class="my_comment_tab">
	<ul class="clearfix">
    	<li id="mct_0" onClick="ShowMyComments(140,0,1)" class="cur">全部评价<span>(0)</span></li>
    	<li id="mct_1" onClick="ShowMyComments(140,1,1)">好评<span>(0)</span></li>
    	<li id="mct_2" onClick="ShowMyComments(140,2,1)">中评<span>(0)</span></li>
    	<li id="mct_3" onClick="ShowMyComments(140,3,1)">差评<span>(0)</span></li>
    	<li id="mct_4" onClick="ShowMyComments(140,4,1)">用户晒单<span>(0)</span></li>
    </ul>
</div>
<div class="blank"></div>
