...
<title>笛莎（DEESHA）新品女童儿童装纯洁清新气质_母婴用品_鸿宇科技多用户商城</title>
...
<body>
<input type="hidden" id="chat_goods_id" value="37" />
...
<table cellpadding=0 cellspacing=0 width="90%" border=0>  
    <tr> 
      ...
      <p style="font-size:15px;font-weight:bold;color:#F52648;padding-bottom:5px;">笛莎（DEESHA）新品女童儿童装纯洁清新气质</p>
    ...
    <tr> 
      ...
      <input type="hidden" value="37" name="goods_id" id="goods_id">
  ...
  <div class="tell_me_con">
  	<table cellpadding="0" cellspacing="0" width="100%" border="0">
        ...
        <td colspan="2" align="left" style="padding:15px 0 15px 0;"><div style="background:#FFFDEE ;padding:10px 10px;border:1px dotted #ff3300;height:40px;line-height:150%; font-weight:normal">
            <p style="font-size:15px;color:#F52648;padding-bottom:5px;">笛莎（DEESHA）新品女童儿童装纯洁清...</p>
    ...
    <table cellpadding=0 cellspacing=0 width="100%" border=0>
      ...
      <tr>
        <td class="td_l">&nbsp;</td>
        <td align="left" class="td_r"><input type="button" value="提交" onclick="tell_me1(37)" class="tell_btn"/>
...
$('.search-type li').click(function() {
  ...
  <div class="blank"></div>
  <div class="w">
  <div class="breadcrumb"><i></i><a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=8">母婴用品</a> <code>&gt;</code> 笛莎（DEESHA）新品女童儿童装纯洁清新气质</div>
</div>
            ...
            <div id="name">
              ...
              <div class="mar_l">
                <p> 
                  ...
                  <span class="depreciate"><a href="javascript:showDiv(37);" style="color:#ffffff;text-decoration:none;">降价通知</a></span> </p>
              </div>
              <div class="show_price" style="z-index:101"> 
                                <div class="market_prices_t"> <span class="price">市场价</span><font class="market_price">321.59</font> </div>
                  ...
                  <div class="hover" style="display:none;" id="vip2" onmouseover="hidevip1()" onmouseout="showvip1()"> <span class="rmbPrice">会员等级价格<i></i></span> 
                    ...
                    <span class="rmbPrice"> 铜牌会员：254.60</span> 
                     
                    </br>
                    <span class="rmbPrice"> 金牌会员：241.20</span> 
                     
                    </br>
                    <span class="rmbPrice"> 钻石会员：227.80</span> 
...
document.getElementById('vip2').style.display="none";
            ...
            <div id="summary-qita" class="clearfix">
              <ul class="qita">
                <li>
                  <p>累积评价<span><a href="/goods.php?id=37#os_pinglun">0人评价</a></span></p>
                </li>
                <li>
                  <p>累计销量<span>0</span></p>
                </li>
                                <li style="border:none">
                  <p>赠送积分<span><font id="ECS_GOODS_AMOUNT_jf">268</font></span></p>
                                </ul>
            </div>
            <ul id="summary">
              <script type="text/javascript">
...
var myString=new Array();
                ...
                <div class="dd">
                  <div class="wrap-input"> 
                    ...
                    <a class="btn-add" href="javascript:;" onclick="goods_add();changePrice();">增加数量</a> 
                                                                             （库存<font id="shows_number">541 </font>）
                                      </div>
                </div>
              </li>
                          </ul>
            <div class="buyNub-buy-wrap">
             ...
             <div id="choose-btns1" class="buyNub-buy" style="display:none"> 
                ...
                <a onclick="tell_me(37)" class="tell_me"/><i></i>到货通知</a>
                
                <a href="javascript:collect(37)" class="btn-coll ">收藏</a>   
              </div>
     
              <div id="choose-btns" class="buyNub-buy"> 
                 
                <a href="javascript:addToCart(37,0,1)" name="bi_addToCart" class="u-buy1">立即购买</a> <a href="javascript:addToCart(37)" name="bi_addToCart" class="u-buy2">加入购物车</a> 
                 
                <a href="javascript:collect(37)" class="btn-coll ">收藏</a> <a id="phone" class="btn-phone" style="position:relative;cursor:pointer">去手机购买
                <div id="phone_tan" style="display:none"> <span class="arr"></span>
                  <div class="m-qrcode-wrap"> <img src="erweima_png.php?id=37" width="100" height="100" /> </div>
                </div>
                </a>  
              </div>
              <script type="text/javascript">
      ...
      <div id="preview">
        <div  class="goods_img" id="li_37"> <a href="images/201507/source_img/37_P_1437508806154.jpg" class="MagicZoom" id="zoom" rel="zoom-position: right;">
                    <img  src="images/201507/goods_img/37_P_1437508806550.jpg" class="goodsimg pic_img_37" id="goods_bimg" width="378" height="378" style="border:#DDDDDD 1px solid; width:378px; height:378px;" />
                    </a> </div>
...
<div class="clearfix" class="goods_picture"> <span class="scrleft" onmouseover="moveLeft()" onmousedown="clickLeft()" onmouseup="moveLeft()" onmouseout="scrollStop()"></span>
  <div class="gallery">
    <div id="demo">
      <div id="demo1" style="float:left;">
        <ul id="goods_gallery">
                    <li>
	    <a  href="images/201507/source_img/37_P_1437508806154.jpg" rel="zoom-id: zoom;" rev="images/201507/goods_img/37_P_1437508806550.jpg"   title="" >
	    <img src="images/201507/thumb_img/37_thumb_P_1437508806860.jpg" alt="笛莎（DEESHA）新品女童儿童装纯洁清新气质" class="B_blue"  />
	    </a>
          </li>
                  </ul>
      </div>
  ...
  <script>
      ...
      function clickRight() {
        ...
        <div id="short-share">
          <div id="view-bigimg" class="fl" style="margin-right:20px;"><b></b><a href="javascript:;" onclick="window.open('gallery.php?id=37'); return false;" target="_blank">查看大图</a></div>
		...
		document.getElementById("bdshell_js").src = "http://bdimg.share.baidu.com/static/js/shell_v2.js?cdnversion=" + Math.ceil(new Date()/3600000);
          ...
          <div class="fl com-pare"> <a class="compare-btn" data-goods="37" data-type="0" onclick="Compare.add(37,'笛莎（DEESHA）新品女童儿童装纯洁清新气质','0', 'images/201507/thumb_img/37_thumb_G_1437508806047.jpg', '321.59')"></a> </div>
          <div class="clb"></div>
        </div>
      </div>
      <div id="supp_info"> 
...
<input type="hidden" id="chat_supp_id" value="2" />
    ...
    <dt class="shop_title">卖家：<a href="supplier.php?suppId=2" target="_blank" style="color:#333333"> 小金蛋母婴旗舰店</a></dt>
    <dd > </dd>
  ...
  <div id="enter-shop"> 
    ...
    <a class="btn_flat1 btn_goto_shop" href="supplier.php?suppId=2" target="_blank">
        进入商店
    </a>
    <a class="btn_flat1 btn_shop_add" href="javascript:guanzhu(2);">
        关注本店
    </a>
	</div>
    <div id="attention-shop">
    	<p>扫一扫，手机访问店铺</p>
	<img src="erweima_supplier.php?sid=2" width="120" height="120" />
    </div>
  </div>
<script>
...
$(function(){
    ...
    <div class="right goods_right">       <div id="wrapper" class="m m1">
        <div class="mt" id="main-nav-holder">
          <ul class="tab" id="nav">
            <li class="boldtit_list h_list" onclick="change_widget(1, this);"><a href="/goods.php?id=37#os_canshu">规格参数</a></li>
            <li class="boldtit_list" onclick="change_widget(1, this);"><a href="/goods.php?id=37#os_jieshao" >商品介绍</a></li>
            <li class="boldtit_list" onclick="change_widget(1, this);"><a href="/goods.php?id=37#os_pinglun" >商品评价(0)</a></li>
            <li class="boldtit_list" onclick="change_widget(1, this);"><a href="/goods.php?id=37#os_shouhou" >售后保障</a></li>
          </ul>
          <div style="width:170px;float:right; position:relative;left:0;top:0"> <a href="javascript:addToCart(37)" name="bi_addToCart"  class="right_add" >加入购物车</a>
            <div class="ce_right">
              <ul class="abs_ul">
        ...
        <div id="main_widget_1">
          <div class="mc" id="os_canshu">
            <ul class="detail-list">
              <li>商品名称：笛莎（DEESHA）新品女童儿童装纯洁清新气质</li>
              <li>商品编号：ECS000037</li>
              <li>品牌：<a href="brand.php?id=12" >姬芮</a></li>
...
<div class="my_comment_tab">
	<ul class="clearfix">
    	<li id="mct_0" onClick="ShowMyComments(37,0,1)" class="cur">全部评价<span>(0)</span></li>
    	<li id="mct_1" onClick="ShowMyComments(37,1,1)">好评<span>(0)</span></li>
    	<li id="mct_2" onClick="ShowMyComments(37,2,1)">中评<span>(0)</span></li>
    	<li id="mct_3" onClick="ShowMyComments(37,3,1)">差评<span>(0)</span></li>
    	<li id="mct_4" onClick="ShowMyComments(37,4,1)">用户晒单<span>(0)</span></li>
    </ul>
</div>
<div class="blank"></div>
