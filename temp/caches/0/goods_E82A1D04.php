  ...
  <script>
      ...
      function clickRight() {
		...
		document.getElementById("bdshell_js").src = "http://bdimg.share.baidu.com/static/js/shell_v2.js?cdnversion=" + Math.ceil(new Date()/3600000);
          ...
          <div class="fl com-pare"> <a class="compare-btn" data-goods="3" data-type="0" onclick="Compare.add(3,'美国西北车厘子 1斤装 进口水果新鲜樱桃水果','0', 'images/201507/thumb_img/3_thumb_G_1437501601556.jpg', '29.00 ')"></a> </div>
          <div class="clb"></div>
        </div>
      </div>
      <div id="supp_info"> 
