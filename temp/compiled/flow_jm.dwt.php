...
?>
  ...
  <?php $_from = $this->_var['consignee_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('sn', 'consignee_0_32784400_1522637082');if (count($_from)):
    foreach ($_from AS $this->_var['sn'] => $this->_var['consignee_0_32784400_1522637082']):
?>
