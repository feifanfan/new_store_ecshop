<!-- $Id: order_stats.htm 16420 2009-07-02 06:56:57Z Shadow & 鸿宇 -->
...
<div class="form-div">
  <form action="" method="post" id="selectForm" name="selectForm">
    ...
    <!--<?php $_from = $this->_var['start_date_arr']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('k', 'start_date_0_74233600_1521680701');if (count($_from)):
    foreach ($_from AS $this->_var['k'] => $this->_var['start_date_0_74233600_1521680701']):
?>-->
    <?php if ($this->_var['k'] > 0): ?>
    &nbsp;+&nbsp;
    <?php endif; ?>
    <input name="year_month[]" value="<?php echo $this->_var['start_date_0_74233600_1521680701']; ?>" style="width:60px;" onclick="return showCalendar(this, '%Y-%m', false, false, this);" /> 
