  ...
  <table border="0" cellpadding="0" cellspacing="0" class="store-joinin">
    ...
    <tbody>
      <tr>
        ...
        <td><input type="text" name="bank_account_name" value="<?php echo htmlspecialchars($this->_var['supplier']['bank_account_name']); ?>" style="float:left;" size="30" /></td>
      </tr><tr>
        <td class="label">公司银行账号：</td>
        <td><input type="text" name="bank_account_number" value="<?php echo htmlspecialchars($this->_var['supplier']['bank_account_number']); ?>" style="float:left;" size="30" /></td></tr>
      <tr>
        <td class="label">开户银行支行名称：</td>
        <td><input type="text" name="bank_name" value="<?php echo htmlspecialchars($this->_var['supplier']['bank_name']); ?>" style="float:left;" size="30" /></td>
      </tr>
      <tr>
        <td class="label">支行联行号：</td>
        <td><input type="text" name="bank_code" value="<?php echo htmlspecialchars($this->_var['supplier']['bank_code']); ?>" style="float:left;" size="30" /></td>
      </tr>
      <tr>
        <td class="label">开户银行许可证<br>电子版：</td>
        <td><?php if ($this->_var['supplier']['bank_licence_electronic']): ?><img src="../data/supplier/<?php echo $this->_var['supplier']['bank_licence_electronic']; ?>" width=50 height=50>&nbsp;&nbsp;<input type="button" onclick="window.open('../data/supplier/<?php echo $this->_var['supplier']['bank_licence_electronic']; ?>');" value="查看原图"><?php endif; ?></td>
      </tr>
    </tbody>
  ...
  <table border="0" cellpadding="0" cellspacing="0" class="store-joinin">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><input type="text" name="rank_name" value="<?php echo htmlspecialchars($this->_var['supplier']['rank_name']); ?>" style="float:left;" size="30" />
		  </td>
        </tr>
        <tr>
...
?> -->
      ...
      <tr>
        ...
        <td><input type="text" name="id_card_no" value="<?php echo htmlspecialchars($this->_var['supplier']['id_card_no']); ?>" style="float:left;" size="30" /></td></tr><tr>
      </tr>
      <tr>
        <td class="label">手持身份证照片：</td>
        <td><?php if ($this->_var['supplier']['handheld_idcard']): ?><img src="../data/supplier/<?php echo $this->_var['supplier']['handheld_idcard']; ?>" width=50 height=50>&nbsp;&nbsp;<input type="button" onclick="window.open('../data/supplier/<?php echo $this->_var['supplier']['handheld_idcard']; ?>');" value="查看原图"><?php endif; ?></td>
      </tr>
      <tr>
        <td class="label">身份证正面：</td>
        <td><?php if ($this->_var['supplier']['idcard_front']): ?><img src="../data/supplier/<?php echo $this->_var['supplier']['idcard_front']; ?>" width=50 height=50>&nbsp;&nbsp;<input type="button" onclick="window.open('../data/supplier/<?php echo $this->_var['supplier']['idcard_front']; ?>');" value="查看原图"><?php endif; ?></td>
      </tr>
      <tr>
        <td class="label">身份证反面：</td>
        <td><?php if ($this->_var['supplier']['handheld_idcard']): ?><img src="../data/supplier/<?php echo $this->_var['supplier']['idcard_reverse']; ?>" width=50 height=50>&nbsp;&nbsp;<input type="button" onclick="window.open('../data/supplier/<?php echo $this->_var['supplier']['idcard_reverse']; ?>');" value="查看原图"><?php endif; ?></td>
      </tr>
    </tbody>
  </table>
