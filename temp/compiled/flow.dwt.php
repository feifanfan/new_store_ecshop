...
<link rel="stylesheet" type="text/css" href="themes/68ecshopcom_360buy/css/teshu.css" />
...
<div class="headerLayout" style="padding-top:15px; padding-bottom:5px;">
  <div class="headerCon ">
    <h1 id="mallLogo" style="padding-top:5px;"> <a href="index.php" class="header-logo"><img src="themes/68ecshopcom_360buy/images/header/logo.jpg" /></a></h1>
    <div class="header-extra" style="height:74px;"> </div>
  </div>
</div>
<div class="block"> 
...
?>
                <LI>
                  ...
                  <a href="javascript:addToCart(<?php echo $this->_var['goods']['id']; ?>)"><img src="themes/68ecshopcom_360buy/images/misc/lib/skin/i/adcart.gif" style="margin-top:5px;"/></a> </LI>
                <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
              </ul>
              <?php endif; ?> 
            </div>
...
?>
          <ul class="clearfix">
            ...
            <li> <a href="<?php echo $this->_var['fittings']['url']; ?>" target="_blank" title="<?php echo htmlspecialchars($this->_var['fittings']['goods_name']); ?>" class="f6"><?php echo htmlspecialchars($this->_var['fittings']['short_name']); ?></a><br />
              ...
              <a href="javascript:fittings_to_flow(<?php echo $this->_var['fittings']['goods_id']; ?>,<?php echo $this->_var['fittings']['parent_id']; ?>)"><img src="themes/68ecshopcom_360buy/images/bnt_buy.gif" alt="<?php echo $this->_var['lang']['collect_to_flow']; ?>" /></a> </li>
          </ul>
          <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?> 
        </div>
      </form>
...
?><br />
          ...
          <tr>
            ...
            <td align="center" bgcolor="#ffffff"><input type="image" src="themes/68ecshopcom_360buy/images/bnt_cat.gif" alt="Add to cart"  border="0" /></td>
          </tr>
          <?php endif; ?>
        </table>
...
?>
        <tr>
          <td  colspan=20 style="background:#DDEFFF; border-bottom:1px solid #ddd; font-weight:bold;" > <?php echo $this->_var['goodsinfo']['0']['seller']; ?>
        </tr>
...
?> 
            ...
            <div class="p-goods">
              ...
              <div class="p-detail" style="float:left; margin-left:15px;">
                ...
                <div class="p-more">商品属性：<?php echo $this->_var['goods']['goods_attr']; ?>&nbsp;</div>
                <?php endif; ?> 
              </div>
            </div>
...
?>
        ...
        <tr>
          <td bgcolor="#ffffff"><strong><?php echo $this->_var['lang']['invoice']; ?>:</strong></td>
          <td bgcolor="#ffffff"><input name="need_inv" type="checkbox"  class="input" style="width:20px;" id="ECS_NEEDINV" onclick="changeNeedInv()" value="1" <?php if ($this->_var['order']['need_inv']): ?>checked="true"<?php endif; ?> />
...
?>
    ...
    <div class="pre_box w">
      ...
      <div align="center" style="margin:20px auto;">
        <input type="image" src="themes/68ecshopcom_360buy/images/jmpic/btn_done.gif" />
  ...
  <div class="flowBox checkBox_jm" style="margin:10px auto 70px auto;">
    <h6 style="text-align:center; height:30px; line-height:30px;color:#ED5854;">订单提交成功！</h6>
...
?>
            <tr >
              <td style="border-bottom:1px solid #ddd;padding-left:15px;background:#FAFAFA; width:445px;" height=30>订单号：<?php echo $this->_var['suborder']['order_sn']; ?></td>
              <td style="border-bottom:1px solid #ddd;background:#FAFAFA"><?php echo $this->_var['suborder']['pay_name']; ?>：<?php echo $this->_var['suborder']['order_amount_formated']; ?></td>
              <td style="border-bottom:1px solid #ddd;background:#FAFAFA"><?php echo $this->_var['suborder']['shipping_name']; ?>&nbsp;&nbsp;&nbsp;<?php echo $this->_var['order']['best_time']; ?></td>
            </tr>
            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
            <?php if ($this->_var['total']['real_goods_count'] == 0): ?>
            <tr>
              <td colspan="3" style="border-bottom:1px solid #ddd;padding-left:15px;background:#FAFAFA; height:30px; text-align:left;">
...
?>
              	<div style="height:30px; line-height:30px; width:50%; float:left;">虚拟商品编号：<?php echo $this->_var['virtual_card2']['card_sn']; ?><?php if ($this->_var['virtual_cart2']['is_verification'] == 0): ?>&nbsp;&nbsp;未使用<?php else: ?>&nbsp;&nbsp;已使用<?php endif; ?></div>
                <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?> 
            	<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
              </td>
            </tr>
      ...
      <tr>
        <td align="center" style="padding-bottom:30px;"> <?php if ($this->_var['pay_online']): ?>
          ...
          <?php else: ?> <a href="user.php?act=order_list"><img src="themes/68ecshopcom_360buy/images/btn_my_orders.gif" border=0 align="absmiddle"></a><?php endif; ?> </td>
      </tr>
    </table>
    <style>
