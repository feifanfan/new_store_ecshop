...
?>
<<<<<<< HEAD
          <?php $_from = $this->_var['title']['options']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'item_0_04026900_1525311746');if (count($_from)):
    foreach ($_from AS $this->_var['item_0_04026900_1525311746']):
?>
            <?php if ($this->_var['title']['can_multi'] == 0): ?>
            <p><input type="checkbox" name="option_id" value="<?php echo $this->_var['item_0_04026900_1525311746']['option_id']; ?>" />
            <?php echo $this->_var['item_0_04026900_1525311746']['option_name']; ?> (<?php echo $this->_var['item_0_04026900_1525311746']['percent']; ?>%)</p>
            <?php else: ?>
            <p><input type="radio" name="option_id" value="<?php echo $this->_var['item_0_04026900_1525311746']['option_id']; ?>" />
            <?php echo $this->_var['item_0_04026900_1525311746']['option_name']; ?> (<?php echo $this->_var['item_0_04026900_1525311746']['percent']; ?>%)</p>
=======
          <?php $_from = $this->_var['title']['options']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'item_0_31455000_1525310422');if (count($_from)):
    foreach ($_from AS $this->_var['item_0_31455000_1525310422']):
?>
            <?php if ($this->_var['title']['can_multi'] == 0): ?>
            <p><input type="checkbox" name="option_id" value="<?php echo $this->_var['item_0_31455000_1525310422']['option_id']; ?>" />
            <?php echo $this->_var['item_0_31455000_1525310422']['option_name']; ?> (<?php echo $this->_var['item_0_31455000_1525310422']['percent']; ?>%)</p>
            <?php else: ?>
            <p><input type="radio" name="option_id" value="<?php echo $this->_var['item_0_31455000_1525310422']['option_id']; ?>" />
            <?php echo $this->_var['item_0_31455000_1525310422']['option_name']; ?> (<?php echo $this->_var['item_0_31455000_1525310422']['percent']; ?>%)</p>
>>>>>>> zmx/master
            <?php endif; ?>
            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
