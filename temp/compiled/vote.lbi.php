...
?>
<<<<<<< HEAD
          <?php $_from = $this->_var['title']['options']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'item_0_14158000_1525336613');if (count($_from)):
    foreach ($_from AS $this->_var['item_0_14158000_1525336613']):
?>
            <?php if ($this->_var['title']['can_multi'] == 0): ?>
            <p><input type="checkbox" name="option_id" value="<?php echo $this->_var['item_0_14158000_1525336613']['option_id']; ?>" />
            <?php echo $this->_var['item_0_14158000_1525336613']['option_name']; ?> (<?php echo $this->_var['item_0_14158000_1525336613']['percent']; ?>%)</p>
            <?php else: ?>
            <p><input type="radio" name="option_id" value="<?php echo $this->_var['item_0_14158000_1525336613']['option_id']; ?>" />
            <?php echo $this->_var['item_0_14158000_1525336613']['option_name']; ?> (<?php echo $this->_var['item_0_14158000_1525336613']['percent']; ?>%)</p>
=======
          <?php $_from = $this->_var['title']['options']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'item_0_75229200_1525412467');if (count($_from)):
    foreach ($_from AS $this->_var['item_0_75229200_1525412467']):
?>
            <?php if ($this->_var['title']['can_multi'] == 0): ?>
            <p><input type="checkbox" name="option_id" value="<?php echo $this->_var['item_0_75229200_1525412467']['option_id']; ?>" />
            <?php echo $this->_var['item_0_75229200_1525412467']['option_name']; ?> (<?php echo $this->_var['item_0_75229200_1525412467']['percent']; ?>%)</p>
            <?php else: ?>
            <p><input type="radio" name="option_id" value="<?php echo $this->_var['item_0_75229200_1525412467']['option_id']; ?>" />
            <?php echo $this->_var['item_0_75229200_1525412467']['option_name']; ?> (<?php echo $this->_var['item_0_75229200_1525412467']['percent']; ?>%)</p>
>>>>>>> ad1ca47ab52ed3c9e71eda049b6504c47fde68bd
            <?php endif; ?>
            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
