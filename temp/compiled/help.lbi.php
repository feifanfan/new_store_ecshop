...
?>
      <dl class="col-links <?php if (($this->_foreach['no']['iteration'] <= 1)): ?>col-links-first<?php endif; ?>">
        ...
        <?php $_from = $this->_var['help_cat']['article']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'item_0_04697800_1522828362');if (count($_from)):
    foreach ($_from AS $this->_var['item_0_04697800_1522828362']):
?>
        <dd><a rel="nofollow" href="help.php?id=<?php echo $this->_var['item_0_04697800_1522828362']['article_id']; ?>" target="_blank"><?php echo $this->_var['item_0_04697800_1522828362']['short_title']; ?></a></dd>
