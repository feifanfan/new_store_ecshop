				...
				<div id="login-box" class="uc_box uc_box_reg">
                	<form action="register.php" method="post" id="formRegister" name="formRegister">
                        ...
                        <ul class="register_tab">
                            <li id="li_register_type_mobile" class="tab_item fl" register_type="mobile">注册账号<span class="bg_ff"></span></li>
					...
					<form action="register.php" method="post" id="formUser" name="formUser" >
						...
						<input type="hidden" name="register_type" value="<?php echo $this->_var['register_type']; ?>" />
							...
							<div class="item">
								<input name="username" type="text" id="username" placeholder="用户名" onblur="checkusername(this)"  class="text" />
								<i class="i-phone"></i>
								<div>
							...
							<div class="item">
								<input name="bd_phone" type="text" id="bd_phone" placeholder="请填写报单中心手机号" onblur="checkbd_phone(this)"  class="text" />
								<i class="i-phone"></i>
								<div>
									<span class="label" id="bd_phone_notice"></span>
								</div>
							</div>
							
							<div class="item">
								<input name="user_parent" type="text" id="user_parent" placeholder="请填写推荐人手机号" onblur="checkuser_parent(this)"  class="text" />
								<i class="i-phone"></i>
								<div>
									<span class="label" id="user_parent_notice"></span>
								</div>
							</div>
							
							<div class="item">
								<span style="height: 16px;float: left;padding: 5px 10px;margin-top: -5px;margin-bottom: 20px;font-size: 18px;">会员级别:</span>
								<SELECT  style="height: 22px;float: left;padding: 0px 10px;margin-top: 0px;font-size: 14px;margin-bottom: 5px;" onchange="check_user_rank()" name="user_rank" id="user_rank">
								...
								<div>
										<span class="label" id="rank_notice" style="float: left"></span>
								</div>
							</div>
